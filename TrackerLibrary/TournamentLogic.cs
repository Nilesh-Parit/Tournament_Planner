...
namespace TrackerLibrary
{
    public static class TournamentLogic
    {
        ...
        public static void CompleteTournament(TournamentModel model)
        {
            ...
            if(model.Prize.Count > 0)
            {
                decimal totalIncome = model.EnteredTeam.Count * model.EntryFee;

                PrizeModel? firstPlacePrize = model.Prize.Where(x => x.PlaceNumber == 1).FirstOrDefault();
                PrizeModel? secondPlacePrize = model.Prize.Where(x => x.PlaceNumber == 2).FirstOrDefault();
            ...
            body.AppendLine("<p>Congratulations to our winners on a great tournament</p>");
            body.AppendLine("<br/>");
        ...
        private static void MarkWinnerInMathups(List<MatchupModel> models)
        {
            //greater or lesser
